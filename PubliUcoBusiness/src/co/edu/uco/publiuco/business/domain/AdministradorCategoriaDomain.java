...
public class AdministradorCategoriaDomain {
	...
	public AdministradorCategoriaDomain(UUID identificador, TipoIdentificacionDomain tipoIdentificacion,
			...
			TipoRelacionInstitucionDomain tipoRelacion, RespuestaDomain confirmacionCorreo,
			RespuestaDomain confirmacionTelefono, EstadoAdministradorCategoriaDomain estado) {
		super();
